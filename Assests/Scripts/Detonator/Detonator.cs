...
public class Detonator : MonoBehaviour {
	...
	*/
	...
	public GameObject heatHazePref;
...
//				_heatwave.Reset();
	...
	public static Material DefaultSmokeAMaterial()
	{
        ...
        defaultSmokeAMaterial = new Material(Shader.Find("Transparent/Diffuse"));
...
//		Texture2D tex = Resources.Load("Detonator/Textures/Smoke") as Texture2D;
	...
	public static Material DefaultSmokeBMaterial()
	{
        ...
        defaultSmokeBMaterial = new Material(Shader.Find("Transparent/Diffuse"));
